...
int main(int argc, char *argv[]) {
  ...
  int input_neurons = input_dimensions;
  int output_neurons = output_dimensions;
...
//  }
  ...
  for (int i = 0; i < nr_epochs; i++) {
    kTrain<<<(N + 255) / 256, (N > 256 ? 256 : N)>>>(network_device,
        train_data_device, nr_samples,
